...
export default function EditInterviewModal({ interview, isOpen, onClose, onSave }: EditInterviewModalProps) {
        ...
        <ScrollArea>
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.status} onValueChange={(value) => handleInputChange('status', value as InterviewStatus)}>
                <SelectTrigger>
